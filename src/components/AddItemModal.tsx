...
interface AddItemModalProps {
  visible: boolean;
  onClose: () => void;
  onAddItem: (itemData: { name: string; quantity: number; unit: UnitOfMeasure }) => void;
}
      ...
      <View className="flex-1 bg-black/50 items-center justify-center p-4">
        ...
        >
          <View className="bg-white rounded-2xl p-6 w-full max-w-sm">
            <Text className="text-xl font-bold text-gray-900 mb-6 text-center">Add Product</Text>
            ...
            <View className="flex-row gap-3">
              ...
              >
                <Text className="text-white font-medium text-center">Add Item</Text>
              </TouchableOpacity>
            </View>
          </View>
        </KeyboardAvoidingView>
